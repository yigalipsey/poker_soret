...
// המרת זיטונים לשקלים: ברירת מחדל 1000 זיטונים = 1 שקל
// ניתן להעביר chipsPerShekel מותאם אישית
export function chipsToShekels(chips: number, chipsPerShekel: number = 1000): number {
  return chips / chipsPerShekel;
}

// המרת שקלים לזיטונים: ברירת מחדל 1 שקל = 1000 זיטונים
// ניתן להעביר chipsPerShekel מותאם אישית
export function shekelsToChips(shekels: number, chipsPerShekel: number = 1000): number {
